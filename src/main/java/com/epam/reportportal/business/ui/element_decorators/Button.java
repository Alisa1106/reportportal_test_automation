...
public class Button extends AbstractElement {
    ...
    private static final String BUTTON_XPATH = "(//*[text()='%s']) | (//button//span[text()='%s'])";
    ...
    public void click() {
        ...
        waiters.waitForElementIsClickable(button, Duration.ofSeconds(SHORT_TIMEOUT_IN_SECONDS));
